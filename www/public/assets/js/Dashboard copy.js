...
function loadReservations() {
    ...
    const reservations = mockReservations[selectedMaterial] || [];
    ...
    calendarContent.innerHTML = generateCalendarGrid(reservations);
}

function showReservationDetails(title, user, status, quantity, date) { // Ajoutez 'date' ici
    const statusText = {
        'confirmed': 'Confirmé',
        'pending': 'En attente',
        'cancelled': 'Annulé'
